...
export default function ClipEditorPrdScriptToolbar({
  ...
  const sheetPanelClass =
    "absolute left-0 top-[calc(100%+4px)] z-[200] w-[min(36rem,calc(100vw-1.5rem))] max-h-[min(52vh,22rem)] overflow-y-auto rounded-lg border border-line bg-surface p-0 shadow-lg";
    ...
    <div ref={rootRef} className="relative shrink-0 border-b border-line bg-fill/20 px-2 py-2">
      <div className="flex flex-wrap items-center gap-2">
        ...
        <div className="relative shrink-0">
          ...
          {prdSheet === "verbal" ? (
            <div className={sheetPanelClass} role="region" aria-label="口癖识别">
        ...
        <div className="relative shrink-0">
          ...
          {prdSheet === "pause" ? (
            <div className={sheetPanelClass} role="region" aria-label="停顿识别">

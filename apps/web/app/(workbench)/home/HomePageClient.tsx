...
import type { HomeOverviewPayload } from "../../../lib/queries/homeOverviewQueries";

export default function HomePageClient({
  initialOverview = null
}: {
  initialOverview?: HomeOverviewPayload | null;
}) {
  ...
  const homeOverviewQuery = useHomeOverviewQuery(
    getAuthHeaders,
    isLoggedIn && ready,
    homeAccountKey,
